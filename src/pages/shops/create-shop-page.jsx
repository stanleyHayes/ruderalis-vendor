...
import {createShop, selectShops} from "../../redux/features/shops/shops-slice";
...
const CreateShopPage = () => {
    ...
    const {loading} = useSelector(selectShops);
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            dispatch(createShop(shopData)).unwrap().then(() => navigate('/shops'));
        }
    });
